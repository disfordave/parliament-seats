...
export default function LandscapeCountryListBanner() {
  ...
  return (
    <>
      <div className="sticky top-4 z-100 h-[80vh] w-full overflow-auto rounded-2xl border-2 border-zinc-200 bg-white shadow-lg dark:border-zinc-700 dark:bg-zinc-900">
